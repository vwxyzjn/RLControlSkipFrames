...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--skip-frames", type=int, help="The number of frames to skip", default=0
    )
    parser.add_argument(
        "--env", type=str, help="The gym environment with continuous observation space on which the experiment runs", default="Taxi-v2"
    )
    parser.add_argument(
        "--max-timestamp", type=int, help="The total number of timestamp to run", default=170000
    )
